  ...
  return(
    <aside onTouchStart={onTouchStart} onTouchMove={e=>{e.preventDefault();onTouchMove(e);}} onTouchEnd={onTouchEnd}
      ...
      <button onClick={onProfileClick} title="Edit profile / Sign out"
        style={{padding:collapsed?"10px 0":"12px 14px",borderLeft:"none",borderRight:"none",borderBottom:"none",borderTop:`1px solid ${C.border}`,display:"flex",alignItems:"center",justifyContent:collapsed?"center":"flex-start",gap:9,background:"transparent",cursor:"pointer",width:"100%",textAlign:"left"}}>
