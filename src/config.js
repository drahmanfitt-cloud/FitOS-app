...
export const mapFormat  = r => r ? ({id:r.id,name:r.name,type:r.type||"circuit",description:r.description||"",totalDuration:r.total_duration||45,workSec:r.work_sec||40,restSec:r.rest_sec||20,rounds:r.rounds||3,stations:r.stations||[],warmup:r.warmup||[],createdAt:r.created_at}) : null;
export const mapWorkout = r => r ? ({id:r.id,name:r.name,focus:r.focus||"",warmup:r.warmup||[],exercises:r.exercises||[],createdAt:r.created_at}) : null;
export const mapTask    = r => r ? ({id:r.id,title:r.title,notes:r.notes||"",dueDate:r.due_date||"",clientId:r.client_id||null,done:!!r.done,createdAt:r.created_at}) : null;
